...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/zalsfyn/v4/main/issue.net"
...
cd /usr/bin
# menu
wget -O menu "https://raw.githubusercontent.com/zalsfyn/v4/main/menu/menu.sh"
wget -O menu-trial "https://raw.githubusercontent.com/zalsfyn/v4/main/menu/menu-trial.sh"
wget -O menu-vmess "https://raw.githubusercontent.com/zalsfyn/v4/main/menu/menu-vmess.sh"
wget -O menu-vless "https://raw.githubusercontent.com/zalsfyn/v4/main/menu/menu-vless.sh"
wget -O running "https://raw.githubusercontent.com/artanodrop/v4/main/menu/running.sh"
wget -O clearcache "https://raw.githubusercontent.com/zalsfyn/v4/main/menu/clearcache.sh"
wget -O menu-trgo "https://raw.githubusercontent.com/artanodrop/v4/main/menu/menu-trgo.sh"
wget -O menu-trojan "https://raw.githubusercontent.com/zalsfyn/v4/main/menu/menu-trojan.sh"

# menu ssh ovpn
wget -O menu-ssh "https://raw.githubusercontent.com/zalsfyn/v4/main/menu/menu-ssh.sh"
...
# menu system
wget -O menu-set "https://raw.githubusercontent.com/zalsfyn/v4/main/menu/menu-set.sh"
...
wget -O about "https://raw.githubusercontent.com/zalsfyn/v4/main/menu/about.sh"
...
wget -O menu-bckp "https://raw.githubusercontent.com/zalsfyn/v4/main/menu/menu-bckp.sh"
